    ...
    <div>
      ...
      <div className="flex items-center justify-center w-screen my-5">
        <form
          ...
          className="p-8 max-w-4xl border border-gray-200 shadow-lg"
        >
          <div className="grid grid-cols-2 gap-2">
            ...
            {companies.length > 0 && (
              <Select
                ...
                className="w-full bg-white text-black hover:bg-black rounded hover:text-white"
              >
          ...
          {loading ? (
            <Button
              variant="outline"
              type="submit"
              className="w-full my-4 rounded-xl bg-white hover:bg-black hover:text-white"
            >
